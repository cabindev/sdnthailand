          ...
          {externalLinks.map((link) => {
            ...
            return (
              <a
                ...
                className="group flex flex-col items-center text-center gap-2 py-3 px-2 rounded-xl hover:bg-gray-50 transition-all duration-200 focus:outline-hidden focus-visible:ring-2 focus-visible:ring-[#ff7834]/50"
              >
