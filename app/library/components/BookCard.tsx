...
export default function BookCard({ book }: { book: Book }) {
  return (
    <article className="bg-white rounded-2xl shadow-xl overflow-hidden hover:transform hover:scale-105 transition-all duration-300 group">
      ...
      <div className="p-6 bg-linear-to-b from-white to-pink-50">
        ...
        <a
          ...
          className="block w-full bg-linear-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white text-lg font-medium text-center py-3 rounded-full transform transition-all duration-300 hover:-translate-y-1"
        >
          อ่านนิทาน ✨
        </a>
      </div>
