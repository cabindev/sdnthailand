  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="animate-pulse">
        <div className="h-8 w-64 bg-gray-200 rounded-sm mb-8"></div>
        <div className="h-4 w-96 bg-gray-200 rounded-sm mb-4"></div>
        <div className="h-4 w-80 bg-gray-200 rounded-sm"></div>
      </div>
    </div>
  )
}
