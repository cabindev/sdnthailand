        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-3 text-white">
              ...
              <Link href="/about/contact" className="inline-flex items-center px-4 py-2 bg-white text-orange-600 rounded-lg hover:bg-orange-100 transition-colors font-medium shadow-md hover:shadow-lg">
                ส่งข้อความถึงเรา
              </Link>
            </div>
